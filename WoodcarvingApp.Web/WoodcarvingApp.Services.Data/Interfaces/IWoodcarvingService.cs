...
namespace WoodcarvingApp.Services.Data.Interfaces
{
	public interface IWoodcarvingService
	{
		...
		Task<int> GetWoodcarvingsCountByFilterAsync(WoodcarvingSearchFilterIndexViewModel inputModel);
		Task<IEnumerable<string>> GetAllWoodcarversAsync();
		Task<IEnumerable<WoodcarvingIndexViewModel>> GetAllWoodcarvingsAsync(WoodcarvingSearchFilterIndexViewModel inputModel);
